...
from common import Adam, FoldingNetDecoder2D, ShapeNet, chamfer_distance


class FoldingNet_noGM(ShapeNet, FoldingNetDecoder2D, Adam):
    ...
    def encoder(self):
        ...
        self.XKrelu("XCov", "X1", 64).XKrelu("X1", "X2", 64).XKrelu("X2", "X3", 64).XKrelu("X3", "X4", 128).XK(
            "X4", "X5", 1024
        ).cc.space()  # BxNx1024
...
if __name__ == "__main__":
    ...
    FoldingNet_noGM(NETWORK_NAME).main()
